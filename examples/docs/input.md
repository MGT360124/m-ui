...
<style>
  .demo-input.demo-zh-CN {
    ...
    .input-with-select .m-input-group__prepend {
  ...
  .m-autocomplete-suggestion.my-autocomplete {
    li {
      line-height: normal;
      padding: 7px *;
...
```html
<div>
  <m-input placeholder="请输入内容" v-model="input3">
    <template slot="prepend">Http://</template>
  </m-input>
</div>
<div style="margin-top: 15px;">
  <m-input placeholder="请输入内容" v-model="input4">
    <template slot="append">.com</template>
  </m-input>
</div>
<div style="margin-top: 15px;">
  <m-input placeholder="请输入内容" v-model="input5" class="input-with-select">
    <m-select v-model="select" slot="prepend" placeholder="请选择">
      <m-option label="餐厅名" value="1"></m-option>
      <m-option label="订单号" value="2"></m-option>
      <m-option label="用户电话" value="3"></m-option>
    </m-select>
    <m-button slot="append" icon="m-icon-search"></m-button>
  </m-input>
</div>
<style>
  .m-select .m-input {
...
<m-autocomplete
  ...
  @select="handleSelect">
  <i
    class="m-icon-edit m-input__icon"
    slot="suffix"
